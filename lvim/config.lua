...
lvim.keys.normal_mode["F12"] = ":b#<cr>"
lvim.keys.insert_mode["F12"] = "<ESC>:b#<cr>"
...
lvim.builtin.telescope.defaults.layout_config.preview_cutoff = 55
...
-- This brings back c-t for back from stack jump
...
--- This plugin can hopefully help with the diagnostics
